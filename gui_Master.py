...
lbl = tk.Label(root, text="Malicious Application Predication using ML", font=('times', 25,' bold '), height=1, width=70,bg="black",fg="red")
lbl.place(x=0, y=0)
# _+++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
def Model_Training():
    ...
    label5 = tk.Label(root,text ="Accracy : "+str(ACC)+"%\nModel saved as malicious_MODEL.joblib",width=45,height=3,bg='khaki',fg='black',font=("Tempus Sanc ITC",14))
...
button4 = tk.Button(root, foreground="white", background="black", font=("Tempus Sans ITC", 14, "bold"),
                    text="Detect Malicious", command=call_file, width=15, height=1)
